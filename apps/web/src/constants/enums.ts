...
export enum MIXPANEL_EVENT_NAME {
  ...
  SCRIBEWEB_PRICING_PLAN_TYPE = 'scribeweb_pricing_plan_type',
  ...
  SCRIBEWEB_MR_UPLOAD_SUCCESS = 'scribeweb_mr_upload_success',
  SCRIBEWEB_MR_UPLOAD_FAILED = 'scribeweb_mr_upload_failed',
  SCRIBEWEB_MR_LOAD_FAILED = 'scribeweb_mr_load_failed',
  SCRIBEWEB_MR_DELETE_FAILED = 'scribeweb_mr_delete_failed',
  SCRIBEWEB_MR_PDF_LOAD_FAILED = 'scribeweb_mr_pdf_load_failed',
