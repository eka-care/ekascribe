...
Prompts live as .md files in voice2rx/agents/prompts/ and are loaded into an
...
# agent key -> prompt file name (without .md) in voice2rx/agents/prompts/
AGENT_PROMPT_NAMES = {
...
class FilePromptService:
    ...
    def get_parsed_agent_prompt(
        ...
        raise FileNotFoundError(
            ...
            f"(missing or invalid file: voice2rx/agents/prompts/{prompt_name}.md)"
        )
