...
from scribe.services.template_authoring_service import TemplateAuthoringService
from scribe.core.dependencies import get_validated_jwt_payload
from scribe.core.error_handler import handle_template_errors
