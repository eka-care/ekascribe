/**
 * Sentry error tracking — disabled for the open-source build.
 * The original implementation is preserved (commented) below; re-enable by
 * restoring it and providing SENTRY_DSN via electron.env.
 */
...
export function addBreadcrumb(_category: string, _message: string, _data?: Extra, _level?: string): void {}
export function captureLog(_name: string, _extra?: Extra): void {}
export function captureError(_error: unknown, _context?: { domain?: string; component?: string; extra?: Extra; tags?: Extra }): void {
