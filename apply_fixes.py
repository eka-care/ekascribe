#!/usr/bin/env python3
"""Apply the 5 vaarta pipeline fixes in place. Idempotent. Run from repo root:
...
patch(
    "services/documents/populate_documents_service.py",
...
patch(
    "services/transactions/result_service_v2.py",
...
patch(
    "services/context/context_resolution_service.py",
...
patch(
    "services/transactions/combine_audios.py",
